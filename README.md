...
**v5.0 post-S4 complete (CRM bidirectional + context pressure awareness).** ~196 source files, 1036 tests passing, zero type errors, 145 tools.
...
- **145 tools** across 5 source plugins (builtin, MCP, Google, memory, skills)
