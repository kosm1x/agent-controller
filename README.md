...
**v5.0 S6 complete + NorthStar.** 197 source files, 1153 tests passing, zero type errors, 134 tools.
...
| v5.0 S6      | Done   | Intelligence Depot foundation (5 collector adapters, signal store, delta engine, polling scheduler)                                                                  |
