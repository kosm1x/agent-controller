...
3. Day 1–7: `mc-ctl briefing-gate` returns `insufficient_data` for §17 while volume accrues (V8.1 §13 stays exit 0 — the combined verdict does NOT demote a passing V8.1 during the V8.2 shadow). Watch the §17 section's five checks + the watchpoints above.
