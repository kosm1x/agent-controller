...
|                                                   | V8.3 Autonomous Execution Gates | **Substrate (Phase 0+1) shipped dormant 2026-06-24** — ledger+seed; v1 pipeline (Phases 2–7) pending; gated on V8.2 + bilateral maturity                      |
